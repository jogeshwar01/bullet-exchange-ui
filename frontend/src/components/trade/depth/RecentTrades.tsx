  ...
  return (
    <div className="h-full flex flex-col py-1 pl-2 pr-2 text-xs text-center recent-trades-header text-vestgrey-100 font-display bg-background">
      ...
      <div className="flex justify-between mb-2">
        <span className="font-[300] text-[12px] text-left border-b-2 border-dashed border-blue-900 w-fit">
          Price
        </span>
        <span className="font-[300] text-[12px] pr-1 text-center border-b-2 border-dashed border-blue-900 w-fit">
          Size ({ticker?.symbol?.split("-")?.[0]})
        </span>
        <span className="font-[300] text-[12px] text-right border-b-2 border-dashed border-blue-900 w-fit">
          Time
        </span>
      </div>
